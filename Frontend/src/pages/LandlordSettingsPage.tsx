...
export default function LandlordSettingsPage() {
  ...
  const [businessHours, setBusinessHours] = useState('8:00 AM - 6:00 PM');
          ...
          {editingBio ? (
            <Card className="border-none shadow-sm rounded-xl">
              <CardContent className="p-4 space-y-3">
                ...
                <div className="space-y-1.5">
                  <Label className="text-xs font-medium">Secondary Contact (Optional)</Label>
                  <Input
                    value={secondaryPhone}
                    onChange={e => setSecondaryPhone(e.target.value)}
                    placeholder="E.g. Assistant's number"
                    className="rounded-lg text-sm"
                  />
                </div>
            ...
            <Card className="border-none shadow-sm rounded-xl">
              <CardContent className="p-4 space-y-4">
                ...
                <div className="space-y-2 pt-2 border-t border-slate-100">
                  ...
                  {secondaryPhone && (
                    <div className="flex justify-between items-center text-sm">
                      <span className="text-slate-500 font-medium">Secondary Contact</span>
                      <span className="font-semibold">{secondaryPhone}</span>
                    </div>
                  )}
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-slate-500 font-medium">Operating Hours</span>
                    <span className="font-semibold text-[#0F3D91]">{businessHours}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
