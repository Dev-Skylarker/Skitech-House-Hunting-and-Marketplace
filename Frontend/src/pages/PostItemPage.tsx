...
export default function PostItemPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Sending Marketplace Media Payload (Array of Strings):', mediaPayload);
        ...
        <div className="max-w-4xl mx-auto relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-white/80 max-w-lg">
              Declutter your space and make some extra cash. Share items with the Embu community.
            </p>
          </div>
