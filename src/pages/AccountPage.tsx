                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Input
                          ...
                          required
                          className={`h-10 text-sm rounded-lg ${regConfirmPassword && regPassword !== regConfirmPassword
          ...
          <CardContent className="p-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <Button className="bg-[#FF7A00] hover:bg-orange-700 text-white rounded-xl font-heading font-bold h-10 px-6">Upload Documents</Button>
              </div>
            </div>
          </CardContent>
        </Card>
    ...
    <div className="space-y-8 max-w-3xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[
          ...
          { icon: HelpCircle, title: 'FAQ Center', desc: 'Find quick answers', action: 'Browse FAQs', color: 'bg-purple-600' },
        ].map((item, i) => (
          <Card key={i} className="border-none shadow-sm rounded-2xl overflow-hidden">
            <CardContent className="p-6">
              ...
              <Button variant="outline" className="w-full rounded-xl font-heading font-bold h-10 border-[#0F3D91] text-[#0F3D91] hover:bg-[#0F3D91]/5">
                {item.action}
              </Button>
            </CardContent>
          </Card>
      ...
      <Card className="border-none shadow-sm rounded-2xl bg-[#0F3D91] text-white overflow-hidden p-0">
        <div className="p-8 relative">
          ...
          <div className="relative z-10 max-w-[400px]">
            ...
            <p className="text-white/80 text-sm leading-relaxed mb-6">Found a suspicious listing or user? Reporting helps us keep the UoEM community safe for everyone.</p>
    ...
    <div className="min-h-screen bg-[#F7F9FC] pb-24">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 md:gap-3">
                <Badge className="bg-white/20 hover:bg-white/30 text-white border-none rounded-full px-2 md:px-3 text-[10px] md:text-xs">
                  {user.userType === 'landlord' ? 'Verified Landlord' : 'Student'}
                </Badge>
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="mt-8 mb-24 text-center">
          <p className="text-[10px] uppercase tracking-widest text-[#0F3D91]/40 font-bold mb-1">Skitech House Hunting & Marketplace - Embu</p>
          <p className="text-[11px] text-slate-400">
            Managed by <a href="https://skitechsolutions.vercel.app" target="_blank" rel="noopener noreferrer" className="font-bold hover:text-[#0F3D91]">Skitech Solutions</a>
          </p>
        </div>
      </div>
    </div>
