...
export default function PostHousePage() {
  ...
  const canAddMoreImages = imageUrls.length < 5;
        ...
        <div className="max-w-4xl mx-auto relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-white/70 max-w-lg">
              Reach thousands of students at UoEM. Provide accurate details to build trust with potential tenants.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    required
                    className="h-12 rounded-xl text-slate-900 border-slate-200 focus:ring-[#0F3D91] focus:border-[#0F3D91] transition-all"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="grid gap-2">
                    ...
                    <Input type="number" placeholder="5,000" required className="h-12 rounded-xl border-slate-200" />
                  </div>
                  <div className="grid gap-2">
            ...
            <div className="p-8 lg:p-12 space-y-8 bg-slate-50/50">
              <div className="flex items-center gap-4 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">Add 3-5 photos. Keep each under 100KB.</p>
                </div>
              </div>
